...
test("workflow runtime resolves fixture inputs and stores step outputs", async () => {
  ...
  await exec(process.execPath, ["scripts/record-workflow-execution.mjs"]);
  ...
  const execution = JSON.parse(await readFile(new URL("../dist/generated/appraise-observational-study.execution.json", import.meta.url), "utf8"));
